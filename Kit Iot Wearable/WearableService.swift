...
let WearableUpdateLocation = "WearableUpdateLocation"
...
class WearableService: NSObject, CBPeripheralDelegate {
    ...
    func sendWearableUpdateLocation(value: NSString) {
        let userInfo = ["value": value]
        
        NSNotificationCenter.defaultCenter().postNotificationName(WearableUpdateLocation, object: self, userInfo: userInfo)
    }
}
